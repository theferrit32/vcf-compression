...
// char *char_to_bin_string(const char c_input) {
//     std::string output;
...
string_array_t split_string(const std::string& s, const std::string& delim, int max_split) {
    string_array_t arr;
    size_t idx = 0;
    size_t search_idx = 0;
    int split_count = 0;
...
uint64_t str_to_uint64(const char* s, bool& success) {
    char *endptr = NULL;
